...
import com.xxl.job.core.biz.model.AbstractJobHandler;
...
public class XxlJobSpringExecutor extends XxlJobExecutor implements ApplicationContextAware, InitializingBean, DisposableBean {
    ...
    static Logger logger=LoggerFactory.getLogger(XxlJobSpringExecutor.class);
    // start
    @Override
    ...
    private void initJobHandlerMethodRepository(ApplicationContext applicationContext) {
        ...
        String[] beanDefinitionNames =applicationContext.getBeanNamesForType(AbstractJobHandler.class);
...
//        String[] beanDefinitionNames = applicationContext.getBeanDefinitionNames();
        for (String beanDefinitionName : beanDefinitionNames) {
            ...
            try {
                ...
                logger.warn("create bean {} with exception:{}",beanDefinitionName,ex);
            }
            if (bean != null) {
